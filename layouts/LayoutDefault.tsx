...
function Topbar(props: { children: JSX.Element }) {
  return (
    <div
      id="sidebar"
      class="flex lg-py-12 py-5 position-sticky top-0 line-height-5 border-b-2 bg-brand flex-justify-between flex-items-center">
      {props.children}
    </div>
  );
}
...
function Logo() {
  return (
    <div class="flex items-center justify-center pl-4">
      <a href="/">
        <img src="/assets/logo.png" class="lg-w-34 w-30"/>
      </a>
    </div>
  );
}
...
function MainFooterMenuItem(props: {href:string, children: JSX.Element }) {
  ...
  function FooterSocialIcon(props: { children: JSX.Element, url: string }) {
    return <a class="flex items-center justify-between color-brand-inv hover-color-brand-light lg-w-13 lg-h-13 w-20 h-20" href={props.url}>
      {props.children}
    </a>
  }
    ...
    function MainFooterSocialIcons() {
      return (
        <div class="flex items-center justify-center lg-mb-6 mb-10 lg-mt-5 mt-9 gap-lg"
        >
