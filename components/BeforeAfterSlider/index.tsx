      ...
      <SliderProvider>
        <div class="max-w-1100px m-auto position-relative hidden md:block cursor-pointer">
          ...
          <SliderButton class="cursor-pointer position-absolute top-45% left-0 lg-left--15 bg-transparent b-none" prev>
            <RiPlayReverseMiniLine class="lg:ml-15 xl:-ml-2 font-size-10 b-solid b-3px p-1 important-hover-c-paper hover-bg-brand-compliment hover-b-brand-compliment transition-colors lg-c-brand-compliment lg-b-brand-compliment md-c-brand-compliment md-b-brand-compliment" style={props.style} />
          </SliderButton>

          <SliderButton class="cursor-pointer position-absolute top-45% right-0 lg-right--15 bg-transparent b-none" next>
            <RiPlayMiniLine class="lg:mr-15 xl:-mr-2 font-size-10 b-solid b-3px p-1 important-hover-c-paper hover-bg-brand-compliment hover-b-brand-compliment transition-colors lg-c-brand-compliment lg-b-brand-compliment md-c-brand-compliment md-b-brand-compliment" style={props.style} />
          </SliderButton>
        </div>
      </SliderProvider>
