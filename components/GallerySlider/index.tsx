      ...
      <SliderProvider>
        <div class="max-w-1100px m-auto position-relative hidden md:block cursor-pointer">
          ...
          <SliderButton class="cursor-pointer position-absolute top-45% left--15 bg-transparent b-none" prev>
            <RiPlayReverseMiniLine class="-ml-2 font-size-10 b-solid b-3px p-1 important-hover-c-paper hover-bg-brand hover-b-brand transition-colors" style={props.style} />
          </SliderButton>
          <SliderButton class="cursor-pointer position-absolute top-45% right--15 bg-transparent b-none" next>
            <RiPlayMiniLine class="-mr-2 font-size-10 b-solid b-3px p-1 important-hover-c-paper hover-bg-brand hover-b-brand transition-colors" style={props.style}/>
          </SliderButton>
        </div>
      </SliderProvider>
      <Show when={open()}>
        <SliderProvider>
          <div class="bg-black bg-opacity-85 z-9999 hidden md:block fixed">
            <div class="fixed top-0 left-0 w-full h-full m-auto bg-black px-10 flex flex-justify-center">
              ...
              <RiCloseFill onClick={() => setOpen(false)} class="z-2 w-16 h-16 absolute top-0 right-0 mr-8 mt-8 p-2 text-white bg-transparent color-brand cursor-pointer hover-color-paper:hover" />
      ...
      <SliderProvider>
        <div class="max-w-1100px m-auto position-relative md:hidden block mx-4">
          ...
          <SliderButton class="cursor-pointer position-absolute top-47% left-0 bg-transparent b-none" prev>
            <RiPlayReverseMiniLine class="-ml-1 font-size-7 b-solid b-2px p-1 c-brand b-brand important-hover-c-paper hover-bg-brand hover-b-brand transition-colors" style={props.style} />
          </SliderButton>
          <SliderButton class="cursor-pointer position-absolute top-47% right-0 bg-transparent b-none" next>
            <RiPlayMiniLine class="-mr-1 font-size-7 b-solid b-2px p-1 c-brand b-brand important-hover-c-paper hover-bg-brand hover-b-brand transition-colors" style={props.style} />
          </SliderButton>
        </div>
      </SliderProvider>
      <Show when={open()}>
        <SliderProvider>
          <div class="bg-black bg-opacity-85 z-9999 h-full md:hidden block fixed">
            <div class="fixed top-0 left-0 w-full h-full m-auto bg-black px-5 flex flex-items-center flex-justify-center">
              ...
              <RiCloseFill onClick={() => setOpen(false)} class="z-2 w-16 h-16 absolute top-0 right-0 mr-2 mt-10 p-2 text-white bg-transparent color-brand cursor-pointer hover-color-paper:hover" />
