            ...
            <AnimatedComponent>
                <Switch>
                    ...
                    <Match when={props.variant === "pink2"}>
                        <img src="/assets/pink-bg-decor.svg" class="md:mb--10 md:mt-5 w-full flex justify-end h-auto ml--110px w-full max-w-650px" style={props.style} alt="Decorative doodle" />
                    </Match>
                    ...
                    <Match when={props.variant === "purple2"}>
                        <img src="/assets/purple-bg-decor.svg" class="md:mb--10 md:mt-5 w-full flex justify-end h-auto md:mr--120px mr--50px w-full max-w-650px" style={props.style} alt="Decorative doodle" />
                    </Match>
