...
export function PriceTable2(props: { title: string, items: TTableEntry[] }) {
	return (
		<div>
			<table class="w-full m-auto font-sans">
                ...
                <For each={props.items}>
                    {(entry) =>                     <tr>
                        <td class="bg-paper pl-5 py-2 font-500">{entry.label}</td>
                        <td class="bg-paper pl-5 py-2 font-500">{entry.value}</td>
                    </tr>}
                </For>
