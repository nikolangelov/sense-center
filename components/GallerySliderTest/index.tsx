...
export const GallerySliderTest = (props: { style?: string | string; imgs: { src: string, alt: string }[] }) => {
      ...
      <SliderProvider>
        <div class="max-w-1100px m-auto position-relative hidden md:block cursor-pointer">
          ...
          <SliderButton class="cursor-pointer position-absolute top-45% left-0 lg-left--15 bg-transparent b-none" prev>
            <RiPlayReverseMiniLine class="ml-0 xl:-ml-2 font-size-10 b-solid b-3px p-1 important-hover-c-paper hover-bg-brand hover-b-brand transition-colors lg-c-paper-inv lg-b-black md-c-brand md-b-brand" style={props.style} />
          </SliderButton>

          <SliderButton class="cursor-pointer position-absolute top-45% right-0 lg-right--15 bg-transparent b-none" next>
            <RiPlayMiniLine class="mr-0 xl:-mr-2 font-size-10 b-solid b-3px p-1 important-hover-c-paper hover-bg-brand hover-b-brand transition-colors lg-c-paper-inv lg-b-black md-c-brand md-b-brand" style={props.style}/>
          </SliderButton>
        </div>
      </SliderProvider>
