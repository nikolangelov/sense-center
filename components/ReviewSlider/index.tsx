...
export function StarReview(props: { hrefGoogleReview: string; name: string; reviewText: string | JSXElement; title?: string; class?: string; }) {
    return (
        <a class="mb-2 md:mb-5 mt-0 m-auto px-2 md:px-6 pt-10 md:pb-10 pb-20 bg-gradient-to-b from-brand-yellow to-brand b-rd-12px" target="_blank" rel="noopener" href={props.hrefGoogleReview}>
            <div class="flex flex-justify-center flex-items-center">
                <div class="flex flex-col flex-justify-center flex-items-center">
                    ...
                    <div class={`flex flex-col justify-between items-end h-550px sm:h-300px md:h-850px lg:h-700px xl:h-700px ${props.class ?? ''}`}>
                        <div class="font-400 c-paper py-7 md:px-0 px-3 font-300 font-size-4 md:font-size-3.8 lg:font-size-4 md:line-height-6 lg:line-height-6.5 xl:line-height-7.3" style="font-family:'Roboto', sans-serif; text-align: left;">{props.reviewText}</div>
                        <div class="w-full">
...
export function ReviewersImageReview(props: { name: string; date: string; reviewText: string | JSXElement; style: string; }) {
    return (
        <div class="mb-2 md:mb-5 mt-0 m-auto px-2 md:px-8 pt-10 md:pb-8 pb-13 b-rd-12px" style={props.style}>
            <div class="flex flex-justify-center flex-items-end h-500px">
                <div class="flex flex-col flex-justify-end flex-items-end">
                    <div class="font-300 c-paper lg-px-0 pb-4 px-3 line-height-5.4 font-size-12px md:font-size-17px">{props.reviewText}</div>
                    <div class="w-full px-3 md:px-0">
                        <p class="font-size-12px md:font-size-17px c-brand-orange font-500 mb-0 mt-0">{props.name}</p>
                        <p class="font-size-12px md:font-size-18px leading-5 tracking-0.2 font-400 c-paper mb-0 mt-0 font-[MYRIADPRO-COND]">{props.date}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <a class="mb-2 md:mb-5 mt-0 m-auto px-2 lg:px-8 pt-13 pb-9 bg-paper b-rd-12px" target="_blank" rel="noopener" href={props.hrefGoogleReview}>
            <div class="flex flex-justify-center flex-items-center">
                <div class="flex flex-col flex-justify-center flex-items-center">
                    ...
                    <div class={`flex flex-col justify-between items-end h-370px sm:h-650px lg:h-470px xl:h-500px googlereview-container ${props.class ?? ''}`}>
...
export function AuthorContainer(props: {
    ...
    return (
        <div class="mb-2 md:mb-10 mt-0 m-auto px-2 md:px-5 pt-10 md:pb-5 pb-20 b-rd-12px w-350px h-350px md:w-400px md:h-400px bg-[position:right_50%_bottom_50%] bg-contain" style={props.style}>
            <div class="flex flex-justify-center flex-items-center h-400px md:h-450px">
                <div class="ml-3">
                    <p class="font-size-18px md:font-size-20px uppercase c-paper font-[MYRIADPRO-Bold] mb-2 mt-0">{props.name}</p>
                    <div class=" c-paper px-0 lg-line-height-6 font-size-15px md:font-size-17px pb-3">{props.description}</div>
                    <div class="w-full">
                        <div class="important-delay-600 float-left md:pr-5px relative text-center max-w-1240px">
                            <a href={props.href} class="">
                                <div class="flex bg-brand-yellow hover:bg-brand-yellow-hover b-rd-100 max-w-100 w-full px-1.5 py-4px md:py-5px">
                                    <div class="flex justify-center items-center bg-paper b-rd-100 w-7 h-7">
                                        <img src="/assets/sense-yellow-puzzle-piece.svg" alt="puzzle piece" class="m-auto w-5 h-5 object-cover" />
                                    </div>
                                    <div class="flex flex-col flex-justify-center flex-items-center gap-2">
                                        <div class="relative min-h-1px px-8px lg-px-10px c-paper flex text-center flex-justify-center tracking-1.3px font-size-3.5 lg:font-size-3.5 font-400 leading-4.5">
                                            Научете повече
                                        </div>
                                    </div>
                                </div>
