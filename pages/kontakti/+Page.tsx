		...
		<div>
			<div class="space-y-6 mb-10 w-full">
				{contacts.map(({ type, value, icon: Icon, link, className }) => (
					<a
						href={link}
						class="flex md:flex-row flex-col items-center md:gap-4 hover:bg-white/30 transition-all duration-300 p-3 md:p-5 rounded-0 shadow-lg cursor-pointer border border-white/30 transform hover:scale-105 hover:shadow-2xl w-full bg-#14100c before:content-[''] relative before:absolute before:top-0 before:left-[80%] before:w-1/2 before:h-full before:bg-gradient-to-l before:from-[rgba(255,255,255,0.15)] before:to-transparent before:transform before:-skew-x-70 before:-translate-x-[160%] overflow-hidden"
						target="_blank"
