  ...
  return <Container>
    ...
    <Entry>
      ...
      <li>
        ...
        <Typography variant="body">Professional mattress cleaning services have access to specialised equipment and cleaning solutions to effectively remove old stains. The following is a general overview of how professionals like Fine Carpet Cleaning will handle the task:</Typography></li>
      <ul class="ml--5" style="list-style: initial;">
        <Typography variant="li">
    ...
    <>
      ...
      <div class="mt-20 py-8 px-8 md-px-14 bg-paper b-rd-3" style="box-shadow: 0px 0px 20px 5px rgb(84 89 95 / 18%);">
        ...
        <ol style="counter-reset: ordered; list-style: none;">
          ...
          <li class="md-ml--5"><Typography variant="body"><strong>Drying</strong> - It takes about 5-7 hours for a steam-cleaned mattress to dry completely. We strongly recommend allowing the mattress to completely dry, especially before use, as damp mattresses are breeding grounds for harmful moulds.</Typography></li>
        </ol>
      </div>
