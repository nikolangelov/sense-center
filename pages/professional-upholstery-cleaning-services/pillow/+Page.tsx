    ...
    <>
      ...
      <div class="mt-20 py-8 px-8 md-px-14 bg-paper b-rd-3" style="box-shadow: 0px 0px 20px 5px rgb(84 89 95 / 18%);">
        <ol style="counter-reset: ordered; list-style: none;">
          <li class="md-ml--5"><Typography variant="body">First, we establish exactly what cleaning detergents and tools need to be used for the specific fabric and type of pillow.</Typography></li>
          <li class="md-ml--5"><Typography variant="body">Second, we use a vacuum cleaner to clean the fabric. This removes any loose dirt, dry soils and dust.</Typography></li>
          <li class="md-ml--5"><Typography variant="body">We then apply heavy duty pre-spray, which lifts oily dirt and pollutants from your pillows, after which they can be safely extracted using our high-performance extraction machines.</Typography></li>
          <li class="md-ml--5"><Typography variant="body">The cleaning solution is worked onto the pillow. This loosens the soiling, making it ready for extraction.</Typography></li>
          ...
          <li class="md-ml--5"><Typography variant="body">Finally, we rinse and extract again to ensure no chemical residues are left behind.</Typography></li>
        </ol>
      </div>
