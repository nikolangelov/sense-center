...
export default function Page() {
    return (
        <>
            <div class="flex flex-justify-center"><img class="b-rd-3 md-mt-10 mt-2 max-w-full" src="/assets/blog/Dog-poop-off-carpet.jpg" alt="professional-stain-removal-service" style="box-shadow: 0px 0px 20px 5px rgb(84 89 95 / 30%);" /></div>
            <h1 class="mt-10 md-mt-17 md-mb-5 font-size-12.5 md-font-size-14 md-line-height-18 line-height-16">How To Clean Carpet Dog Poop
            </h1>
            ...
            <h2 class="line-height-12 md-line-height-14">Why can dog feces be dangerous to health?
            </h2>
            <div class="mt-20 py-8 px-8 md-px-14 bg-paper b-rd-3" style="box-shadow: 0px 0px 20px 5px rgb(84 89 95 / 18%);">
                <p>
            ...
            <h2 class="line-height-12 md-line-height-14">10 Simple Steps for Removing Animal Faeces From Your Carpet</h2>
            <div class="mt-20 py-8 px-8 md-px-14 bg-paper b-rd-3" style="box-shadow: 0px 0px 20px 5px rgb(84 89 95 / 18%);">
                <p>
                ...
                <h3>Step 1: You must know the type of carpet to apply the appropriate method for cleaning fabric</h3>
                <p>
                ...
                <h3>Step 2: Get the right equipment and other accessories</h3>
                <p>
                ...
                <ul>
                    <li class="ml--5">
                        <p>A pair of household rubber gloves</p>
                    </li>
                    <li class="ml--5">
                        <p>Soft brush</p>
                    </li>
                    <li class="ml--5">
                        <p>Nylon bag that you can fasten after collecting floor stains</p>
                    </li>
                    <li class="ml--5">
                        <p>Cardboard or paper pieces</p>
                    </li>
                    <li class="ml--5">
                        <p>White clean towels</p>
                    </li>
                    <li class="ml--5">
                        <p>Oxygen-based bleach – laundry detergent is also appropriate in this case dishwasher</p>
                    </li>
                    <li class="ml--5">
                        <p>Bucket, light or another mixer a little water</p>
                    </li>
                    <li class="ml--5">
                        <p>A little white vinegar</p>
                    </li>
                    <li class="ml--5">
                        <p>Baking soda</p>
                    </li>
                ...
                <h3>Step 3: Remove the hard parts</h3>
                <p>
                    Usually, the stools are hard and their removal is easier, but if it is diarrhea then things get complicated:
                </p>
                <ul>
                    <li class="ml--5">
                        <p>whatever kind of is a defeat, start with solid contaminants. Remember the rubber gloves and take a hard card or paper that is easy to collect from the floor</p>
                    </li>
                    <li class="ml--5">
                        <p>try to pick up as much as possible from the stools</p>
                    </li>
                    <li class="ml--5">
                        <p>be careful with smudging on the floor and rubbing – you should try not to go beyond the colored brown area and the dirt does not go deep</p>
                    </li>
                    <li class="ml--5">
                        <p>put everything in the bag and tie it well</p>
                    </li>
                    <li class="ml--5">
                        <p>discard the bag in outer containers to prevent the terrible odor from spreading, no matter how dirty it may be.</p>
                    </li>
                </ul>

                <h3>Step 4: Apply stain pre-treatment</h3>
                <p>
                ...
                <h3>Step 5: Make the cleaning fluid and place it directly on the stain</h3>
                <p>
                ...
                <h3>Step 6: Begin with a more serious cleaning</h3>
                <p>
                ...
                <h3>Step 9: Eliminate Odors</h3>
                <p>
                    The thought of having a terrible odor is scary, but there are some basic tricks to dealing with this problem:
                </p>
                <ul>
                    <li class="ml--5">
                        <p>mix 1: 1 white vinegar and distilled water (if possible)</p>
                    </li>
                    <li class="ml--5">
                        <p>soak the stain and leave it there for a few minutes to absorb odors,</p>
                    </li>
                    <li class="ml--5">
                        <p>then dry with clean paper or microfiber towels.</p>
                    </li>
                </ul>
                <h3>Step 10: Last trick for more powerful odor elimination</h3>
                <p>
