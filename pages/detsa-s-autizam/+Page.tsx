		...
		<>
							...
							<div class="bg-paper mx-auto">
								<div class="">
									...
									<div class="flex flex-col items-center gap-1 relative md:hidden">
										<h2 class="text-transparent bg-clip-text bg-[url(/assets/detsa-s-autizam/деца-с-аутизъм.webp)] bg-cover bg-center opacity-8 scale-30 md:scale-50" style="background-position: right 0% top 0%;">
											аутизъм
										</h2>
									</div>
								</div>
			...
			<section class="pb-10">
				...
				<div class="pb-50px xl:px-30">
					<div class="">
						<AnimatedComponent>
							<h4 class="font-600 text-left pb-2">Социални затруднения при деца с аутизъм</h4>
							<div class="block xl:hidden">
								<ContainerSlider
									reviews={[
										{ name: "Review 1" },
			...
			<section class="md:pb-30 pt-10">
				...
				<div class="flex md:flex-row flex-col justify-center items-center md:gap-8 max-w-1500px mx-auto">
					...
					<AnimatedComponent class="flex flex-col items-center gap-1 relative mb-2 md:hidden">
						<h2 class="text-transparent bg-clip-text bg-[url(/assets/detsa-s-autizam/поставяне-диагноза-дете-аутизъм.webp)] bg-cover bg-center opacity-8 scale-30 md:scale-50" style="background-position: right 0% top 0%;">
							аутизъм
						</h2>
					</AnimatedComponent>
				...
				<div class="flex flex-col justify-center items-center max-w-1500px mx-auto px-20px xl:px-30">
					<AnimatedComponent class="max-w-1500px px-5 md:px-20 md:py-10 py-5 bg-gradient-to-t from-brand-yellow to-brand b-rd-12px flex flex-col">
						<p class="c-paper mb-1">
							В Sense Center предлагаме <strong class="font-900">първична оценка</strong> за деца със съмнение за аутизъм.
						</p>
						<p class="c-paper">
						...
						<p class="c-paper mb-1">
							С помощта на тест за аутизъм се оценяват уменията на детето за социално взаимодействие, способността за комуникация, както и наличието на повтарящи се движения и специфични интереси.
						</p>
						<p class="c-paper">
						...
						<div>
							...
							<div class="w-full py-20px text-center">
								<div class="flex flex-col gap-1">
									...
									<p class="text-left font-size-15px mt-2">
									...
									<p class="text-left font-size-15px mt-3">
									...
									<p class="text-left font-size-15px mt-2 c-brand font-600">
			...
			<section class="py-20">
							...
							<div class="w-full h-full">
								<div class="bg-paper mx-auto">
									<div class="">
										...
										<div class="flex flex-col items-center gap-1 relative md:hidden">
											<h2 class="text-transparent bg-clip-text bg-[url(/assets/detsa-s-autizam/терапия-на-дете-с-аутизъм.webp)] bg-cover bg-center opacity-8 scale-30 md:scale-50" style="background-position: right 0% top 0%;">
												аутизъм
											</h2>
										</div>
									</div>
				...
				<div class="xl:px-60 mx-auto md:pt-0 pt-10">
					...
					<AnimatedComponent>
						<p class="md:px-10 md:mb-5 mb-2 mt-0 c-gray-700 leading-5 font-size-14px font-400 italic tracking" style="font-family: 'Oswald', sans-serif !important; letter-spacing: 0.3px;">Препоръчват се от 8 до 24 занимания за деца с аутизъм седмично за оптимални резултати</p>
					</AnimatedComponent>
				...
				<div class="xl:px-30 mx-20px mx-auto">
					...
					<div class="max-w-300px sm:w-300px md:w-700px flex flex-col max-w-full relative overflow-hidden mx-auto" style="flex: 0 0 auto;">
						<AnimatedComponent class="flex flex-col gap-1">
							...
							<p class="text-left font-size-15px mt-2 font-[MYRIADPRO-Semibold] mb-12">
					...
					<div class="relative md:mx-10">
						...
						<AnimatedComponent class="mb-10">
							<div class="flex flex-col justify-center items-start b-rd-12px bg-brand px-10 py-4">
								<p class="font-size-17px c-paper font-500 mb-0">Знания и умения</p>
								<p class="font-size-15px c-paper font-300">Научете повече за особеностите на аутизма и подходящите методи за работа с деца в аутистичния спектър.<br />
						...
						<AnimatedComponent class="mb-10">
							<div class="flex flex-col justify-center items-start b-rd-12px bg-brand-blue px-10 py-4">
								<p class="font-size-17px c-paper font-500 mb-0">Търпение и последователност</p>
								<p class="font-size-15px c-paper font-300">Необходимо е ежедневно да отделяте време за работа с детето. Постоянството и ангажираността на родителите играят ключова роля в постигането на напредък.</p>
							</div>
						</AnimatedComponent>
						<AnimatedComponent class="mb-10">
							<div class="flex flex-col justify-center items-start b-rd-12px bg-#F7871D px-10 py-4">
								<p class="font-size-17px c-paper font-500 mb-0">Инвестиция</p>
								<p class="font-size-15px c-paper font-300">Употребата на помощни средства като визуални карти, книги, образователни играчки и приложения, специално разработени за деца с аутизъм, може значително да подобри резултатите.</p>
							</div>
						</AnimatedComponent>
					</div>
				</div>
