...
export default function Page() {
    return (
        <>
            <div class="flex flex-justify-center"><img class="b-rd-3 md-mt-10 mt-2 max-w-full" src="/assets/blog/protector2.png" alt="professional-stain-removal-service" style="box-shadow: 0px 0px 20px 5px rgb(84 89 95 / 30%);" /></div>
            <h1 class="mt-10 md-mt-17 md-mb-5 font-size-12.5 md-font-size-14 md-line-height-18 line-height-16">Should You Scotchgard After Carpet Cleaning
            </h1>
            ...
            <div class="mt-20 py-8 px-8 md-px-14 bg-paper b-rd-3" style="box-shadow: 0px 0px 20px 5px rgb(84 89 95 / 18%);">
                <ul>
                    <li class="ml--5">
                        <p>Use the purchased spray to protect only on a new carpet after deep hygiene on a slightly damp pad or on a dry surface (the latter option is recommended at least).</p>
                    </li>
                    <li class="ml--5">
                        <p>Prepare rubber gloves and goggles to avoid accidental contact with skin or eyes.</p>
                    </li>
                    <li class="ml--5">
                        <p>Apply Scotchgard when you are at home – avoid having small children and pets around you that can swallow part of the preparation or get on the carpet.</p>
                    </li>
                    <li class="ml--5">
                        <p>Test how the tissue solution will work – it is best to do it on a final stretch or on an area under furniture, on another invisible part.</p>
                    </li>
                    <li class="ml--5">
                        <p>Read the directions for use carefully – the spray should be shaken and sprayed at a distance of about 20 cm from the surface, sprayed evenly and sequentially – from one end to the other of the carpet.</p>
                    </li>
                    <li class="ml--5">
                        <p>Apply Scotchgard especially on silk, viscose or wool pavements.</p>
                    </li>
                    <li class="ml--5">
                        <p>Drying the carpet is also important – at least 12 hours should not step on it and do not place objects.</p>
                    </li>
                </ul>
            </div>
