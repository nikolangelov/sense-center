...
export default function Page() {
    return (
        <>
            ...
            <h1 class="mt-10 md-mt-17 md-mb-5 font-size-12.5 md-font-size-14 md-line-height-18 line-height-16">Carpet Cleaning Spray – Do They Really Work
            </h1>
            <div class="font-sans font-size-3.5 font-500" style="letter-spacing: 1px;">POSTED ON NOVEMBER 22, 2019</div>
            ...
            <h2 class="line-height-12 md-line-height-14">One cleaning spray or several different ones?
            </h2>
            <div class="mt-20 py-8 px-8 md-px-14 bg-paper b-rd-3" style="box-shadow: 0px 0px 20px 5px rgb(84 89 95 / 18%);">
                <p>
            ...
            <h2 class="line-height-12 md-line-height-14">Tips for choosing a carpet spray spray</h2>
            <div class="mt-20 py-8 px-8 md-px-14 bg-paper b-rd-3" style="box-shadow: 0px 0px 20px 5px rgb(84 89 95 / 18%);">
                <p>
                ...
                <h3>Do not pick up the first spray you notice in the store</h3>
                <p>
                ...
                <h3>Seek advice from the sales consultant at the store</h3>
                <p>
                ...
                <h3>Ask for advice from family and friends</h3>
                <p>
                ...
                <h3>Look for more information on the ratings of the best carpet cleaners</h3>
                <p>
                ...
                <h3>Do research for the brand you are aiming for</h3>
                <p>
