...
export default function Page() {
  return (
    <>
      <div class="mt-20"><GalerrySlider></GalerrySlider></div>

      <h1 class="mt-17">Who are we?</h1>
      ...
      <h3 style="font-family: 'Mona-Sans', sans-serif;" class="mt-25 mb-15 font-size-8 line-height-13">Fine Carpet Cleaning London is a qualified member of <a class="color-paper-link hover-color-paper-link-hover:hover" href="/" target="_blank" rel="noopener">"NCCA"</a> (National Carpet Cleaners Association)</h3>
      ...
      <h3 style="font-family: 'Mona-Sans', sans-serif;" class="mt-25 mb-15 font-size-8 line-height-13">Fine Carpet Cleaning London is listed on <a class="color-paper-link hover-color-paper-link-hover:hover" href="/" target="_blank" rel="noopener">“Checkatrade"</a></h3>
      ...
      <h3 style="font-family: 'Mona-Sans', sans-serif;" class="mt-25 mb-15 font-size-8 line-height-13">Fine Carpet Cleaning London staff members are trained and certified</h3>
