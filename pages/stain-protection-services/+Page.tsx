...
export function FaqSection() {
  ...
  return <Container>
    <Entry>
      <ul>
        <li>
          <Typography variant="h3">Will you fee me if I cancel the carpet stain protection?</Typography>
    ...
    <Entry>
      <ul>
        ...
        <li>
          <Typography variant="h3">Can you give me a quote for the carpet stain protection over the phone or do you need a viewing in person?</Typography>
        ...
        <li>
          <Typography variant="h3">What payment methods do you accept for the carpet stain protection?</Typography>
        ...
        <li>
          <Typography variant="h3">Can you add a discount to the furniture stain protection?</Typography>
        ...
        <li>
          <Typography variant="h3">How much does your sofa stain protection service cost?</Typography>
        ...
        <li>
          <Typography variant="h3">How is stain protection performed?</Typography>
        ...
        <li>
          <Typography variant="h3">Is stain guard worth it?</Typography>
        ...
        <li>
          <Typography variant="h3">Why is stain protection used?</Typography>
    ...
    <Entry>
      <ul>
        <li>
          <Typography variant="h3">Why do I need protection on my carpets?</Typography>
        ...
        <li>
          <Typography variant="h3">How long does a stain guard last? </Typography>
        ...
        <li>
          <Typography variant="h3">Is there something better than Scotchgard?</Typography>
        ...
        <li>
          <Typography variant="h3">How long will Scotchgard last?</Typography>
        ...
        <li>
          <Typography variant="h3">What can I put on my carpet to prevent stains?</Typography>
        ...
        <li>
          <Typography variant="h3">What fabric should you not Scotchgard?</Typography>
          <Typography variant="body">We suggest applying a stain protector on every fabric except leather.</Typography></li>
        <li>
          <Typography variant="h3">Does Scotchgard change feel of fabric?</Typography>
        ...
        <li>
          <Typography variant="h3">Does washing remove Scotchgard?</Typography>
        ...
        <li>
          <Typography variant="h3">How long after Scotchgard can I sit on the couch?</Typography>
