    ...
    <Entry>
      <ul>
        ...
        <li>
          ...
          <Typography variant="body">To learn more, check out our <a class="color-paper-link hover-color-paper-link-hover:hover" href="/prices">rug cleaning prices</a>.</Typography>
        </li>
        <li>
