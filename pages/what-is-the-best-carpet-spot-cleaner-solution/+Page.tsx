...
export default function Page() {
    return (
        <>
            <div class="flex flex-justify-center"><img class="b-rd-3 md-mt-10 mt-2 max-w-full" src="/assets/blog/Spray.jpg" alt="professional-stain-removal-service" style="box-shadow: 0px 0px 20px 5px rgb(84 89 95 / 30%);" /></div>
            <h1 class="mt-10 md-mt-17 md-mb-5 font-size-12.5 md-font-size-14 md-line-height-18 line-height-16">What Is The Best Carpet Spot Cleaner Solution
            </h1>
            ...
            <h2 class="line-height-12 md-line-height-14">What are the types of carpet stains that cleaners struggle with?
            </h2>
            <div class="mt-20 py-8 px-8 md-px-14 bg-paper b-rd-3" style="box-shadow: 0px 0px 20px 5px rgb(84 89 95 / 18%);">
                <p>
            ...
            <h2 class="line-height-12 md-line-height-14">Which are some of the best suggestions for reliable remedies for carpet stains?</h2>
            <div class="mt-20 py-8 px-8 md-px-14 bg-paper b-rd-3" style="box-shadow: 0px 0px 20px 5px rgb(84 89 95 / 18%);">
                <h3>Folex Carpet Spot Remover</h3>
                <p>
                ...
                <h3>Resolve Carpet Spot and Stain Remover</h3>
                <p>
                ...
                <h3>Sunny and Honey Enzyme Cleaner, Pet Stain Remover, and Odor Eliminator</h3>
                <p>
                ...
                <h3>Capture Carpet Dry Cleaner</h3>
                <p>
                ...
                <h3>BISSELL Professional Power Shot Oxy Carpet Spot and Stain Remover</h3>
                <p>
