  ...
  return (
    <>
      ...
      <div class="bg-paper b-rd-3" style="box-shadow: 0px 0px 20px 5px rgb(84 89 95 / 10%);">
        <div class="flex flex-col md-flex-row flex-justify-between flex-items-center pb-2 pt-7 md-pt-10 md-pt-8 px-2 w-90% m-auto gap-1">
        ...
        <div class="flex flex-justify-between py-3 md-py-2 px-1 w-90% m-auto gap-3">
          ...
          <div class="font-sans font-500 font-size-4.3 md-font-size-5 text-right whitespace-nowrap my-auto"><a class="color-paper-link-hover hover-color-paper-link:hover" href="tel:+44 7874 333 356" target="_blank" rel="noopener">+44 7874 333 356</a></div>
        </div>
        <hr class="w-90% h-2px b-hidden bg-paper-border" />
        <div class="flex flex-justify-between py-3 md-py-2 px-1 w-90% m-auto gap-3">
          <div class="font-sans font-500 font-size-4.3 md-font-size-5 uppercase text-left">Call landline:</div>
          <div class="font-sans font-500 font-size-4.3 md-font-size-5 text-right whitespace-nowrap my-auto"><a class="color-paper-link-hover hover-color-paper-link:hover" href="tel:+44 2036 370 033" target="_blank" rel="noopener">+44 2036 370 033</a></div>
        </div>
        <hr class="w-90% h-2px b-hidden bg-paper-border" />
        <div class="flex flex-justify-between py-3 md-py-2 px-1 w-90% m-auto gap-3">
          <div class="font-sans font-500 font-size-4.3 md-font-size-5 uppercase text-left">Call Whatsapp:</div>
          <div class="font-sans font-500 font-size-4.3 md-font-size-5 text-right whitespace-nowrap my-auto"><a class="color-paper-link-hover hover-color-paper-link:hover" href="https://wa.me/+447874333356" target="_blank" rel="noopener">+44 7874 333 356</a></div>
        </div>
        <hr class="w-90% h-2px b-hidden bg-paper-border" />
        <div class="flex flex-justify-between pt-3 pb-7 md-py-2 px-1 w-90% m-auto gap-3">
          ...
          <div class="font-sans font-500 font-size-4.3 md-font-size-5 whitespace-nowrap text-right whitespace-nowrap my-auto"><a class="color-paper-link-hover hover-color-paper-link:hover" href="https://wa.me/+447874333356" target="_blank" rel="noopener">Click to chat</a></div>
        </div>
