...
export default function Page() {
    return (
        <>
            <div class="flex flex-justify-center"><img class="b-rd-3 md-mt-10 mt-2 max-w-full" src="/assets/blog/home-carpet-.jpg" alt="professional-stain-removal-service" style="box-shadow: 0px 0px 20px 5px rgb(84 89 95 / 30%);" /></div>
            <h1 class="mt-10 md-mt-17 md-mb-5 font-size-12.5 md-font-size-14 md-line-height-18 line-height-16">How To Clean Wool Carpets Yourself
            </h1>
            ...
            <h2 class="line-height-12 md-line-height-14">What do you get when you buy a wool carpet?
            </h2>
            <div class="mt-20 py-8 px-8 md-px-14 bg-paper b-rd-3" style="box-shadow: 0px 0px 20px 5px rgb(84 89 95 / 18%);">
                <p>
                ...
                <ul>
                    <li class="ml--5">
                        <p>wool carpets are characterized by exceptional durability and strength</p>
                    </li>
                    <li class="ml--5">
                        <p>have insulated function and retain heat</p>
                    </li>
                    <li class="ml--5">
                        <p>high color stability – used natural dyes for their manufacture</p>
                    </li>
                    <li class="ml--5">
                        <p>surface wave repels water</p>
                    </li>
                    <li class="ml--5">
                        <p>wool is a renewable resource</p>
                    </li>
                    <li class="ml--5">
                        <p>The wool is not combustible material, making woollen carpets safer home</p>
                    </li>
                    <li class="ml--5">
                        <p>wool carpet does not get dirty easily and dirt does not show</p>
                    </li>
                    <li class="ml--5">
                        <p>good moisture absorption</p>
                    </li>
                    <li class="ml--5">
                        <p>can make test the authentic kind of carpet and its quality – in touch with real fire wool smells like burnt hair</p>
                    </li>
                </ul>
            </div>
            ...
            <h2 class="line-height-12 md-line-height-14">Bad practices when cleaning a wool carpet</h2>
            <div class="mt-20 py-8 px-8 md-px-14 bg-paper b-rd-3" style="box-shadow: 0px 0px 20px 5px rgb(84 89 95 / 18%);">
                <h3>Cleaning wool carpet with water is absolutely forbidden</h3>
                <p>
                    This is advisable not mean that it is absolutely forbidden. Many simply do not know the extent to which they can moisten the carpet and overdo it. In addition, natural fibers (hair type) do not completely exclude the use of water, but it should be dispersed evenly in minimal amounts, which can be done with special machines. Professional equipment boasts high power, which means it will produce the desired high water extraction.
                </p>
                <h3>Wet cleaning causes the carpet to shrink</h3>
                <p>
                ...
                <h3>Wet cleaning causes browning of the carpet</h3>
                <p>
            ...
            <h2 class="line-height-12 md-line-height-14">Appropriate Methods for Cleaning Wool Carpets</h2>
            <div class="mt-20 py-8 px-8 md-px-14 bg-paper b-rd-3" style="box-shadow: 0px 0px 20px 5px rgb(84 89 95 / 18%);">
                <h3>Cleaning with a Vacuum Cleaner</h3>
                <p>
                ...
                <ul>
                    <li class="ml--5">
                        <p>Make a mixture of water and shampoo or liquid soap (put a few drops). It is a safe preparation, but you should be careful with the degree of wetting of the fabric</p>
                    </li>
                    <li class="ml--5">
                        <p>Use a soft brush for application to the surface</p>
                    </li>
                    <li class="ml--5">
                        <p>Pass vacuum (possibly has a powerful action, the plug is soft fibers)</p>
                    </li>
                    <li class="ml--5">
                        <p>A solution of water and vinegar does a good the trick to regaining color brightness – soak a clean cloth with liquid and apply lightly on the surface to freshen the carpet.</p>
                    </li>
                    <li class="ml--5">
                        <p>Here, as with all other types of carpets, the rule for instant action applies. In the event of a spill, respond quickly and without much thought. Sometimes only a uniform sprinkling of warm water can be effective if on time. Other preparations made with environmentally friendly ingredients can be used, but rubbing should be extremely delicate and with circular motions.</p>
                    </li>
                </ul>
                <h3>“Dry cleaning” of woollen carpets </h3>
                <p>
