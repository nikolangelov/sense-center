...
export default function Page() {
    return (
        <>
            <div class="flex flex-justify-center"><img class="b-rd-3 md-mt-10 mt-2 max-w-full" src="/assets/blog/carpet-cleaning-London-4.jpg" alt="professional-stain-removal-service" style="box-shadow: 0px 0px 20px 5px rgb(84 89 95 / 30%);" /></div>
            <h1 class="mt-10 md-mt-17 md-mb-5 font-size-12.5 md-font-size-14 md-line-height-18 line-height-16">How To Use White Vinegar To Clean Carpet Stains
            </h1>
            ...
            <h2 class="line-height-12 md-line-height-14">Is there any danger of vinegar staining your carpet?</h2>
            <div class="mt-20 py-8 px-8 md-px-14 bg-paper b-rd-3" style="box-shadow: 0px 0px 20px 5px rgb(84 89 95 / 18%);">
                <p>
            ...
            <h2 class="line-height-12 md-line-height-14">The process of cleaning your carpet with white vinegar</h2>
            <div class="mt-20 py-8 px-8 md-px-14 bg-paper b-rd-3" style="box-shadow: 0px 0px 20px 5px rgb(84 89 95 / 18%);">
                <p>
                ...
                <h3>Step 2: Make a solution with vinegar</h3>
                <p>
                ...
                <h3>Step 3: Begin with a substantial cleaning of the carpet</h3>
                <p>
                ...
                <h3>Step 5: Removing excess moisture</h3>
                <p>
